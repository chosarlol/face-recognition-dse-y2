...
Live recognition using:
  ...
  - "Unknown" label whenever the SVM's top-class probability is below
    CONFIDENCE_THRESHOLD, instead of forcing a guess
  - Rolling 5-frame smoothing for stable labels, FPS counter
...
CONFIDENCE_THRESHOLD  = 0.65    # SVM probability threshold — tune between 0.5-0.8
SMOOTH_FRAMES         = 5
